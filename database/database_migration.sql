-- ============================================
-- TrainTrack - Database Migration Script
-- ============================================
-- This script safely updates your existing database
-- to support all new features from the design
-- ============================================
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    -- Set join_date to created_at for existing records
...
-- ============================================
-- STEP 4: Create or replace views
-- ============================================
